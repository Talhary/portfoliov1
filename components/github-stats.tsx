...
export const GitHubStats = () => {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-card-bg-3/60 border border-zinc-200 dark:border-zinc-800/80 dark:backdrop-blur-xl rounded-2xl p-6 sm:p-8 shadow-sm dark:shadow-2xl relative overflow-hidden transition-all duration-300 hover:border-primary/20 group">
      {/* Glowing accent lights */}
      <div className="absolute top-0 right-0 -mr-16 -mt-16 w-36 h-36 bg-primary/5 rounded-full blur-3xl pointer-events-none group-hover:bg-primary/10 transition-colors duration-300" />
      ...
      <div className="space-y-6 relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a 
                ...
                className="text-xs text-primary hover:underline font-semibold block mt-0.5"
              >
                github.com/talhary
              </a>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Repositories */}
          <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200/60 dark:bg-black/20 dark:border-white/5 dark:backdrop-blur-sm relative overflow-hidden group/card hover:border-primary/20 transition-all duration-200">
            ...
            <div className="mt-2.5 flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-zinc-550 font-medium">active</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200/60 dark:bg-black/20 dark:border-white/5 dark:backdrop-blur-sm relative overflow-hidden group/card hover:border-primary/20 transition-all duration-200">
            ...
            <div className="mt-2.5 flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-zinc-550 font-medium">network</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200/60 dark:bg-black/20 dark:border-white/5 dark:backdrop-blur-sm relative overflow-hidden group/card hover:border-primary/20 transition-all duration-200">
            ...
            <div className="mt-2.5 flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-zinc-550 font-medium">member</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200/60 dark:bg-black/20 dark:border-white/5 dark:backdrop-blur-sm relative overflow-hidden group/card hover:border-primary/20 transition-all duration-200">
            ...
            <div className="mt-2.5 flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-zinc-550 font-medium">status</span>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto custom-scrollbar pb-2">
            ...
            <div className="grid grid-flow-col grid-rows-7 gap-1 min-w-[720px] p-0.5">
              {gridData.map((intensity, index) => (
                <div
                  key={index}
                  className={`h-2.5 w-2.5 rounded-[2px] border transition-all duration-150 hover:scale-125 hover:border-primary cursor-pointer ${
