...
const Section = ({ className }: { className?: string }) => {
  return <div className={`${className} sidebar-image-section`}>
    <div className={`dark:bg-[#32312f] dark:text-black text-white p-1 md:w-[70%] md:mx-auto md:my-4 rounded-xl sidebar-image-box`}>
      <Image
    ...
    <div>
      ...
      <p className="dark:bg-[#32312f] bg-zinc-100 text-xl my-2 md:w-fit p-1.5 px-3 rounded-md md:mx-auto text-zinc-850 dark:text-white border border-zinc-200 dark:border-none sidebar-title">
