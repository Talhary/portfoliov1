        ...
        ({ h, p, Logo, url }, i) => {
          ...
          return (
            <div key={i} className="flex items-center w-full group/aside py-1.5 sidebar-item">
              <div className="rounded-xl dark:bg-[#222224] p-3 bg-zinc-50 border border-zinc-200 dark:border-white/5 text-primary shadow-sm transition-all duration-300 group-hover/aside:border-[#e49505]/40 group-hover/aside:shadow-[0_0_12px_rgba(228,149,5,0.25)] group-hover/aside:-translate-y-0.5">
                {Logo}
              </div>
              {url ? (
